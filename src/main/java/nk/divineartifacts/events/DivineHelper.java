...
import static nk.divineartifacts.client.handler.ClientForgeHandler.toggleExplode;
...
public class DivineHelper {
	...
	public static final List< ResourceKey< DamageType > > FIRE_DAMAGE_TYPES = Arrays.asList(
			DamageTypes.IN_FIRE ,
			DamageTypes.ON_FIRE ,
			DamageTypes.LAVA ,
	...
	public static final Set< TagKey< Item > > curioTags = Set.of(
			ItemTags.create( new ResourceLocation( "artifacts" , "artifacts" ) )
	);
	...
	public static boolean isHandEmptyOrNotTool( ItemStack handItem ) {
		List< Class< ? extends Item > > classList = Arrays.asList(
				SwordItem.class ,
				PickaxeItem.class ,
				ShovelItem.class ,
				AxeItem.class ,
