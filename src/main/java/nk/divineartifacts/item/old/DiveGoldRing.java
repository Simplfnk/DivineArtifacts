...
public class DiveGoldRing extends ItemBaseClass {


	public DiveGoldRing(Properties properties , String tooltip , Supplier<Boolean> enabled , GlintRenderTypes glintType) {
