...
public class DeadKingHeart extends ItemBaseClass {
		...
		return new ICapabilityProvider() {
			...
			private final LazyOptional<ICurio> lazyCurio = LazyOptional.of(() -> new ICurio() {
				...
				public List<Component> getAttributesTooltip(List<Component> tt) {
					...
					List<Component> tooltips = ICurio.super.getAttributesTooltip(tt);
					return DeadKingHeart.this.getAttributesTooltip(replaceTooltips(tooltips));
				}
	...
	public void appendHoverText(@NotNull ItemStack stack , @Nullable Level worldIn , @NotNull List<Component> tooltip , @NotNull TooltipFlag flagIn) {
		...
		TextColor loreColor = TextColor.fromRgb(0xFF6464);
		...
		MutableComponent lore = Component.translatable("lore." + DivineArtifacts.MODID + ".heart").withStyle(s -> s.withColor(loreColor));
		MutableComponent lore2 = Component.translatable("lore2." + DivineArtifacts.MODID + ".heart").withStyle(s -> s.withColor(loreColor));
		MutableComponent lore3 = Component.translatable("lore3." + DivineArtifacts.MODID + ".heart").withStyle(s -> s.withColor(loreColor));
		MutableComponent lore4 = Component.translatable("lore4." + DivineArtifacts.MODID + ".heart").withStyle(s -> s.withColor(loreColor));
		MutableComponent lore5 = Component.translatable("lore5." + DivineArtifacts.MODID + ".heart").withStyle(s -> s.withColor(loreColor));
		...
		MutableComponent a3 = Component.translatable("heart.3." + DivineArtifacts.MODID + ".tooltip").withStyle(s -> s.withColor(Value));
