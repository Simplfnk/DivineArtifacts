...
public class IceTabletBase extends ItemBaseClass {

	public IceTabletBase(Properties properties , String tooltip , Supplier<Boolean> enabled , GlintRenderTypes glintType) {
