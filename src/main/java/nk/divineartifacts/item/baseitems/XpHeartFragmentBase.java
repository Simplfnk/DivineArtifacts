...
public class XpHeartFragmentBase extends ItemBaseClass {

	public XpHeartFragmentBase(Properties properties , String tooltip , Supplier<Boolean> enabled , GlintRenderTypes glintType) {
		...
		return new ICapabilityProvider() {
			...
			private final LazyOptional<ICurio> lazyCurio = LazyOptional.of(() -> new ICurio() {
				...
				public List<Component> getAttributesTooltip(List<Component> tt) {
					...
					List<Component> tooltips = ICurio.super.getAttributesTooltip(tt);
					return XpHeartFragmentBase.this.getAttributesTooltip(replaceTooltips(tooltips));
				}
