...
public class EvocationTabletBase extends ItemBaseClass {

	public EvocationTabletBase(Properties properties , String tooltip , Supplier<Boolean> enabled , GlintRenderTypes glintType) {
