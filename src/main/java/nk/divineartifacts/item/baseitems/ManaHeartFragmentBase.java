...
public class ManaHeartFragmentBase extends ItemBaseClass {
	...
	public ManaHeartFragmentBase(Properties properties , String tooltip , Supplier<Boolean> enabled , GlintRenderTypes glintType) {
		...
		return new ICapabilityProvider() {
			...
			private final LazyOptional<ICurio> lazyCurio = LazyOptional.of(() -> new ICurio() {
				...
				public List<Component> getAttributesTooltip(List<Component> tt) {
					...
					List<Component> tooltips = ICurio.super.getAttributesTooltip(tt);
					return ManaHeartFragmentBase.this.getAttributesTooltip(replaceTooltips(tooltips));
				}
