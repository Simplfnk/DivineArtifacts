...
public class LightningTabletBase extends ItemBaseClass {
	public LightningTabletBase(Properties properties , String tooltip , Supplier<Boolean> enabled , GlintRenderTypes glintType) {
